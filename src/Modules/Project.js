...
class Project extends Component {
  ...
  state = {
    pjts : [
      {id:"pjt1", title :"Love Your Planet", bgImage: `${webpage1}`, contents :"environmental friendly platform", Technology:"MongoDB, Express, React, Typescript"},
      {id:"pjt2", title :"LET EAT GO", bgImage: `${webpage2}`, contents :"Creating a community restaurant info web platform  ", Technology:"React, AWS, Heroku, Express"},
      {id:"pjt3", title :"Abalone", bgImage: `${webpage3}`, contents :"Game 'Abalone' with Machine learning", Technology:"HTML/CSS, JAVASCRIPT, Machine Learning"},
      {id:"pjt4", title :"TAIWAN FEST", bgImage: `${webpage4}`, contents :"Creating a a website that provides festival attendees a creative way to view artworks that are featured in 2020 festival", Technology:"React, Heroku"},
      {id:"pjt5", title :"FISABC", bgImage: `${webpage5}`, contents :"Assist client to improve data collection process by developing a python script", Technology:"Python"},
      {id:"pjt6", title :"LUNARFEST", bgImage: `${webpage6}`, contents :"Developing an app designed for Lunar New Year celebrations in Canada, providing festival information (e.g. maps) and schedules for festival attendees", Technology:"Android Studio, Firebase"}
