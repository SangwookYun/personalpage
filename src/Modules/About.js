    ...
    <Container fluid>
      ...
      <Row style={{marginBottom:"50px"}}>
        <Col xl={{span:4, offset:2}}>
          ...
          <div className = "title_myself"><b>Name :</b> Sangwook Yun</div>
          <div className = "title_myself"><b>Nationality :</b> Korean</div>
          <div className = "title_myself"><b>Degree :</b>2-years Diploma(CST), BS(International Studies) </div>
          <div className = "title_myself"><b>Hobbies :</b> Soccer, Piano, Cooking</div>
          <p className="contents_myself">I am currently a student at BCIT pursuing Computer System Technology Diploma.
